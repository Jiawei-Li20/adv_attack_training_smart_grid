...
for bound in bound_list:
    ...
    result.to_csv(f"result_0new_{adv_attack}_{prepath}_{mixed}_{args.net}{attacked}.csv")
...
# plt.plot(bound_list, (np.array(no_list)-original_cost)/original_cost, marker = 'o', color ="blue",label = "cost under attack")
# plt.plot(bound_list, (np.array(trivial_list)-original_cost)/original_cost, marker = 'o', color = "orange",label = "cost under attack and trivial battery")
# plt.plot(bound_list, (np.array(mn_list)-original_cost)/original_cost, marker = 'o', color = "green", label = "cost under attack and theoretical battery mechanism")
# plt.plot(bound_list, (np.array(mn_theta_list)-original_cost)/original_cost, marker = 'o', color='red',label = "cost under attack and empirical battery mechanism")
# plt.plot(bound_list, (np.array(opt_list)-original_cost)/original_cost, marker = 'o', color ="black",label = "cost under attack and optimal battery mechanism")
# plt.legend()
# plt.ylabel("cost damage ratio")
# plt.xlabel("attack ratio(percent)")
# plt.title(data_file)

# plt.savefig(data_file + '/cost_damage_result.png')
# plt.clf()
# plt.style.use('seaborn-whitegrid')
# # plt.plot(bound_list, (np.array(no_list)-original_cost)/original_cost, marker = 'o', color ="blue",label = "cost under attack")
# plt.plot(bound_list, (np.array(trivial_list)-original_cost)/original_cost, marker = 'o', color = "orange",label = "cost under attack and trivial battery")
...
# plt.savefig(data_file + '/cost_damage_result_2lines.png')