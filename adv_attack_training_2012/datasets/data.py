...
import pytz
import datasets.entsoe
import datasets.weather
import json
...
def load_dataset(path=None, update_date=None, modules=None):
    ...
    #                   'weekday_6':41,
    #                   'hour_0': 42, 'hour_1':42, 'hour_2':44, 'hour_3':45, 'hour_4':46, 'hour_5':47,
    ...
    #                   'hour_20':62, 'hour_21':63, 'hour_22':64, 'hour_23':65,
    #                   'month_1':66, 'month_2':67, 'month_3':68,
    ...
    columns_simple=['actual','temperature']
    columns_full=['actual','temperature','precipitation','air_density','cloud_cover']
    # columns = []
