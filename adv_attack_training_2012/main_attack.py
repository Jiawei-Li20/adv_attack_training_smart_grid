...
model.save_weights('results_2022/rnn_cleanfivesteps.h5')
model.save_weights('results_2022/rnn_substitute.h5')

y_result = model.predict(x_test)
y_real = y_test
plt.plot(y_result[:300, 0], 'r')
plt.plot(y_real[:300, 0], 'b')
plt.savefig('results_2022/training_result.png', dpi=150)
# plt.show()
...
with sess.as_default():
    for outer_loop in range(1, 21):
        ...
        model.load_weights('results_2022/rnn_substitute.h5')
        ...
        model.load_weights('results_2022/rnn_cleanfivesteps.h5')
        ...
        plt.savefig('results_2022/load_attack_noise%.2f_temp.png' % eps, dpi=150)
        # plt.show()
...
with open('results/load_original.csv', 'w') as f:
    writer = csv.writer(f)
    writer.writerows(original_data)