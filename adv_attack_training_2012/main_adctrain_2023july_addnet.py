...
#     return product_y
# # ''' test session
# # ol = np.array([0,np.math.floor(mean),len(plant_cost_curve)-2])
...
# l = (ol - mean)/np.sqrt(var)
# print(0, 1,-0.10700128, -0.13569216, -0.07747312,l)
# # # print(l)
